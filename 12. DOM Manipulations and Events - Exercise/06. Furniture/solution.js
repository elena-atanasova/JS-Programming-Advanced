...
//   Array.from(btns).forEach((el) => el.addEventListener("click", buy));

//   function buy(e) {

//     if (e.target.textContent === 'Generate') {
//       let arr = JSON.parse(textareaElement[0].value);
...
//         imageElement.setAttribute("src", x.img);
//         imageColElement.appendChild(imageElement);
//         tableElement.appendChild(imageColElement);

//         let nameColElement = document.createElement('td');
//         let pElement = document.createElement('p');
//         pElement.textContent = x.name;
//         nameColElement.appendChild(pElement);
//         tableElement.appendChild(nameColElement);

//         let priceColElement = document.createElement('td');
//         let priceElement = document.createElement('p');
//         priceElement.textContent = x.price;
//         priceColElement.appendChild(priceElement);
//         tableElement.appendChild(priceColElement);

//         let decColElement = document.createElement('td');
//         let factorElement = document.createElement('p');
//         factorElement.textContent = x.decFactor;
//         decColElement.appendChild(factorElement);
//         tableElement.appendChild(decColElement);
